const Hero = () => {
  return (
    <div className="bg-[#EDEDED] dark:bg-[#1C1C1C] flex  justify-center items-center h-[90vh] w-full">
      <section className="absolute left-0 top-[-2px] h-[90vh] text-center dark:text-[#EDEDED] w-[25vw] z-10 bg-[#EDEDED] dark:bg-[#1C1C1C] p-2 border-r-[2px] border-solid border-black dark:border-white">
        <div className="h-12">
      ...
      <div className="w-[75vw] h-[90vh] object-contain absolute left-[25vw] top-0 bg-white dark:bg-black opacity-30 z-20" />
      <video
        loop
        muted
        autoPlay
        className="w-[75vw] h-[90vh] object-cover absolute left-[25vw] top-0"
      >
