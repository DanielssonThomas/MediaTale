...
export const Button = ({ text, backgroundColor }: ButtonProps) => {
  return (
    <button
      className={`${backgroundColor} group border-solid border-[1px] border-black dark:border-white md:border-none relative w-40 h-[2rem] bg-transparent overflow-hidden`}
    >
