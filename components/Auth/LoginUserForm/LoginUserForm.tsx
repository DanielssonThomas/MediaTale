    ...
    <div className="flex justify-center w-full">
      <section className="flex flex-col justify-center items-center w-[25rem] gap-8 dark:text-[#EDEDED]">
        <div className="flex flex-col justify-center gap-2 text-center pt-4">
          ...
          <i>
            First time? Welcome! Enter your email and password. If you are new,
            just click sign up! If you have an account, just click the sign in
          </i>
        </div>
        <form
        ...
        >
          ...
          <Button text="Sign Up" type="formAction" formAction="/auth/sign-up" />
