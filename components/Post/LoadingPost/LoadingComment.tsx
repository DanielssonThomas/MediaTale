  ...
  return (
    <div>
      <div className="relative border-solid border-black dark:border-[#EDEDED] border-[1px] rounded-md  text-black dark:text-[#EDEDED]">
        <div className="absolute left-[-15px] top-[-10px] w-[30px] h-[30px] rounded-full overflow-hidden border-black dark:border-[#EDEDED] border-solid bg-[#232323]" />
        <div className="border-solid border-black dark:border-[#EDEDED] border-b-[1px] p-4 text-black dark:text-[#EDEDED]">
          <h3 className="text-sm w-16 h-4 bg-[#232323] mb-2"></h3>
          <p className="text-xs w-full h-12 bg-[#232323]"></p>
        </div>
